...
public class NetworkSpecParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "CAPITALIZED_ID", "ID", "INT", "MOBILEFLAG", "WS", "','", "':'", "';'", "'devices'", "'mobile'", "'networkaddress'", "'region'", "'resources'", "'type'" };
	...
	// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:23:1:
	// networkspec : 'devices' ':' ( device_def )* ;
	public final void networkspec() throws RecognitionException {
		try {
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:23:12:
			// ( 'devices' ':' ( device_def )* )
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:24:7:
			// 'devices' ':' ( device_def )*
			{
				...
				// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:27:5:
				// ( device_def )*
				loop1: do {
					int alt1 = 2;
					...
					switch (alt1) {
					case 1:
					// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:27:6:
					// device_def
					{
	...
	// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:30:1:
	// device_def : deviceName= ( ID | CAPITALIZED_ID ) ':' 'region' ':' (
	// location_def )* 'type' ':' ( device_type )* ';' 'resources' ':' (
	// abilities_def )* ';' ( mobileFlag_def )* ';' ;
	public final void device_def() throws RecognitionException {
		Token deviceName = null;

		try {
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:30:11:
			// (deviceName= ( ID | CAPITALIZED_ID ) ':' 'region' ':' (
			// location_def )* 'type' ':' ( device_type )* ';' 'resources' ':' (
			// abilities_def )* ';' ( mobileFlag_def )* ';' )
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:31:4:
			// deviceName= ( ID | CAPITALIZED_ID ) ':' 'region' ':' (
			// location_def )* 'type' ':' ( device_type )* ';' 'resources' ':' (
			// abilities_def )* ';' ( mobileFlag_def )* ';'
			{
				...
				// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:37:18:
				// ( location_def )*
				loop2: do {
					int alt2 = 2;
					...
					switch (alt2) {
					case 1:
					// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:37:19:
					// location_def
					{
				...
				// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:38:16:
				// ( device_type )*
				loop3: do {
					int alt3 = 2;
					...
					switch (alt3) {
					case 1:
					// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:38:17:
					// device_type
					{
				...
				// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:39:21:
				// ( abilities_def )*
				loop4: do {
					int alt4 = 2;
					...
					switch (alt4) {
					case 1:
					// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:39:22:
					// abilities_def
					{
				...
				// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:40:5:
				// ( mobileFlag_def )*
				loop5: do {
					int alt5 = 2;
					...
					switch (alt5) {
					case 1:
					// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:40:6:
					// mobileFlag_def
					{
	...
	// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:44:1:
	// mobileFlag_def : 'mobile' ':' MOBILEFLAG ;
	public final void mobileFlag_def() throws RecognitionException {
		Token MOBILEFLAG1 = null;

		try {
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:44:16:
			// ( 'mobile' ':' MOBILEFLAG )
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:45:4:
			// 'mobile' ':' MOBILEFLAG
			{
	...
	// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:49:1:
	// networkAddress_def : 'networkaddress' ':' INT ;
	public final void networkAddress_def() throws RecognitionException {
		Token INT2 = null;

		try {
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:49:20:
			// ( 'networkaddress' ':' INT )
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:50:3:
			// 'networkaddress' ':' INT
			{
	...
	// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:54:1:
	...
	public final void location_def() throws RecognitionException {
		...
		try {
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:54:14:
			// ( CAPITALIZED_ID ':' INT ';' )
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:55:5:
			// CAPITALIZED_ID ':' INT ';'
			{
	...
	// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:60:1:
	// device_type : CAPITALIZED_ID ;
	public final void device_type() throws RecognitionException {
		Token CAPITALIZED_ID5 = null;

		try {
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:60:13:
			// ( CAPITALIZED_ID )
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:61:6:
			// CAPITALIZED_ID
			{
	...
	// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:65:1:
	...
	public final void abilities_def() throws RecognitionException {
		...
		try {
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:65:15:
			// ( CAPITALIZED_ID ( ',' abilities_def )? )
			// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:66:4:
			// CAPITALIZED_ID ( ',' abilities_def )?
			{
				CAPITALIZED_ID6 = (Token) match(input, CAPITALIZED_ID, FOLLOW_CAPITALIZED_ID_in_abilities_def282);

				// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:66:19:
				// ( ',' abilities_def )?
				int alt6 = 2;
				...
				switch (alt6) {
				case 1:
				// Y:\\git\\ToolSuite\\ANTLR\\src\\fr\\inria\\arles\\pankesh\\parser\\antlr\\NetworkSpec.g:66:20:
				// ',' abilities_def
				{
