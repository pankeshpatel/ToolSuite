...
public class PubSubMiddleware implements EventNotificationListener {
	...
	private Set<Subscriber> subscriberSet = Collections.synchronizedSet(new HashSet<Subscriber>());
	...
	public static PubSubMiddleware getInstance(Device device) {
	...
	public void initialize(String type, String name) {
		...
		if (type == "PC") {
			...
			ibicoopInput[0] = Startup.myContext;
			ibicoopInput[1] = "testBroker1@ibicoop.org";
			ibicoopInput[2] = "testPasssword";
			ibicoopInput[3] = "Pankesh";
		}
	...
	public void receiveEvent(IbiTopic forTopic, IbiTopicEvent event) {
		...
		DataWrapper dt = (DataWrapper) obj;
			...
			Set<Subscriber> subscriberEventSet = getSubscribersForEvent(forTopic.getName());
